...
export default function NotFound() {
  return (
    <>
      ...
      <div data-aos="fade-up" className="mt-6 mb-6 mx-6">
        {/* Header: Desktop */}
        ...
        <main data-aos="fade-up" className="max-w-[1550px] mx-auto mt-10 md:mt-28 xl:mt-42 px-4 md:px-6 lg:px-0 xl:px-16 2xl:px-24 text-center text-white flex flex-col items-center gap-6">
          ...
          <section className="flex flex-col items-center max-w-8xl">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-xs md:text-sm text-black mb-2 lt-regular">
            ...
            <p className="text-xs md:text-[15px] lg:text-[21px] xl:text-[19px] 2xl:text-xl max-w-[38ch] md:max-w-[47ch] lg:max-w-[46ch] xl:max-w-[66ch] text-black mb-6 lt-regular">
