...
export default function Mean() {
  return (
    <div
      className={`px-4 sm:px-10 md:px-6 lg:px-12 xl:px-12 2xl:px-12 py-10 md:py-0 lg:py-10 mt-16 md:mt-0 lg:mt-12 xl:mt-16 max-w-[1550px] 2xl:max-w-[1905px] mx-auto overflow-x-hidden`}
    >
      {/* Content + Image Section */}
      <div className="flex flex-col-reverse md:flex-col lg:flex-row lg:items-stretch items-center justify-between md:gap-14">
        {/* Text Content */}
        <div className="order-2 md:order-none w-full md:w-full lg:w-1/3 lg:flex lg:flex-col lg:justify-between pb-0 lg:pb-16">
        ...
        {/* Image */}
        <div className="order-first md:order-none w-full pb-16 md:pb-0 md:w-full lg:w-2/3 xl:w-[740px] mt-8 md:mt-0 drop-shadow-[0_20px_50px_rgba(107,114,128,0.25)]">
          <Image
      ...
      <hr className="hidden md:block border-t border-gray-300 mt-3 md:mt-20 lg:mt-3 " />
    </div>
  );
}
