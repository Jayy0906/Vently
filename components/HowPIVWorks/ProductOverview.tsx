      ...
      <div data-aos="fade-up" className="px-4 md:px-10 lg:px-10 xl:px-10 2xl:px-12  max-w-[1440px] mx-auto 2xl:max-w-[1600px] mt-20 md:mt-4 lg:mt-20 xl:mt-20 2xl:-mt-20">
        <div
          className="
                        ...
                        xl:flex xl:flex-row xl:space-x-57 items-start 2xl:gap-5 /* For XL/2XL: h2 and text/button block are side-by-side */
                        "
        >
          <div>
            <h2 data-aos="fade-up" className="hidden md:block text-[30px] md:text-4xl lg:text-[42px] lt-semibold text-[#010A12] max-w-3xl">
              Product overview
            </h2>
            <h2 data-aos="fade-up" className="md:hidden text-[30px] md:text-4xl lg:text-[42px] lt-semibold text-[#010A12] max-w-3xl">
              Our proven solution
            </h2>
          </div>
          {/* Inner container for paragraph and button */}
          <div
            className="text-sm md:text-base lg:text-[17px] text-[#010A12] leading-relaxed max-w-full md:max-w-[100%] xl:max-w-[83ch] 2xl:max-w-[93ch]
        ...
        <hr data-aos="fade-up" className="my-6 lg:my-10 border-t border-gray-300" />

        {/* Carousel */}
        <div className="relative -mt-20 md:-mt-50 lg:-mt-34">
          {/* Image Gallery */}
          ...
          {/* Scrollbar */}
          <div className="-mt-10 md:-mt-46 lg:-mt-30 xl:-mt-28">
            <div data-aos="fade-up"
              ref={scrollTrackRef}
              aria-hidden="true"
