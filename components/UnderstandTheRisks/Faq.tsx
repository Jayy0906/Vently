...
export default function UnderstandSectionFAQ() {
  ...
  return (
    <div data-aos="fade-up"
      className={`text-[#010A12] mt-20 max-w-[1440px] mx-auto px-4 sm:px-10 md:px-6 lg:px-4 xl:px-10 lg:mt-30`}
    >
      {/* Header Row */}
        ...
        <div className="flex-1 divide-y divide-[#D9D9D9]">
          {faqs.map((faq, index) => (
            <div key={index} className="py-4">
              ...
              {openStates[index] && (
                <p data-aos="fade-up" className="text-[16px] font-normal leading-[20px] text-[#010A12]/80 max-w-3xl pt-2 pb-1 transition-all duration-300 ease-in-out">
                  {faq.answer}
                </p>
              )}
            </div>
