  ...
  return (
    <>
      ...
      <div className={`mt-6 mb-6 mx-6`}>
        ...
        {/* Main Content */}
        <main data-aos="fade-up" className="relative max-w-[1440px] mx-auto mt-10 md:mt-34 lg:mt-34 xl:mt-38 px-4 md:px-6 text-center text-white flex flex-col items-center lg:items-start gap-6">
          {/* Hero Text */}
          <section className="flex flex-col items-center lg:items-start max-w-8xl">
            ...
            {/* Heading */}
            <h1 data-aos="fade-up" className="text-[27px] md:text-[3rem] lg:text-[4.5rem] leading-tight lt-semibold max-w-[18ch] md:max-w-[17ch] text-start text-[#010A12] md:mt-8 lg:mt-0">
              Why Choose Positive Input Ventilation (PIV)?
            </h1>

            <p data-aos="fade-up" className="text-xs md:text-[18px] max-w-[40ch] md:max-w-[51ch] text-[#010A12] mb-">
        ...
        <hr data-aos="fade-up" className="hidden md:block border-t border-gray-300 mt-10" />
      </div>
    </>
  );
}
